...
def run():
    class TrainApp:
        ...
        def create_widgets(self):
            title_label = tk.Label(self.root, text="Train Ticket Booking", font=("Helvetica", 18, "bold"), bg="#4682B4",
                                   fg="white")
            ...
            tk.Label(train_frame, text="Select Train:", font=("Helvetica", 12, "bold"), bg="#ADD8E6").grid(row=0,
                                                                                                           column=0,
                                                                                                           padx=10)
